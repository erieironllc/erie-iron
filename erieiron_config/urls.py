...
urlpatterns = [
    ...
    path("_task/prompt-improvement/generate/<str:task_id>", views.action_generate_task_prompt_improvement, name="action_generate_task_prompt_improvement"),
    path("_task/prompt-improvement/apply/<uuid:improvement_id>", views.action_apply_task_prompt_improvement, name="action_apply_task_prompt_improvement"),
    path("_task/prompt-improvement/reject/<uuid:improvement_id>", views.action_reject_task_prompt_improvement, name="action_reject_task_prompt_improvement"),
    path("_task/prompt-improvement/rollback/<uuid:improvement_id>", views.action_rollback_task_prompt_improvement, name="action_rollback_task_prompt_improvement"),
