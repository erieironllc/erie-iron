...
def test_sync_default_workflows_creates_board_and_business_graph():
    ...
    assert board_workflow.source_kind == WorkflowDefinitionSourceKind.APPLICATION_REPO.value
    ...
    assert business_workflow.source_kind == WorkflowDefinitionSourceKind.APPLICATION_REPO.value
