...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            try:
                sts_client = aws_utils.client("sts")
                current_identity = sts_client.get_caller_identity()
                secretsmanager_client = aws_utils.client("secretsmanager")
            ...
            credentials_secret_arn = store_credentials_secret(
                cloud_account, credentials_payload
            )
