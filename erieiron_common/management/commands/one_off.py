...
import settings
from erieiron_autonomous_agent.business_level_agents import worker_coder, eng_lead
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        self.do_selfdriver(business, 'task_summarization_worker_llm')
    ...
    def do_selfdriver(self, business: Business, task_id):
        ...
        sdt = SelfDrivingTask.objects.get(related_task_id=task_id)
        self_driver.execute(sdt.config_path)
