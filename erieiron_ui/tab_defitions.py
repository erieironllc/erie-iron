...
INITIATIVE_TAB_DEFINITIONS = [
    ...
    },
    {
        "slug": "project-plan",
        "label": "Project Plan",
        "template": "initiative/tabs/project_plan.html",
        "context_fn": views._initiative_tab_context_project_plan,
    },
    TAB_DIVIDER,
    {
        "slug": "architecture",
...
BUSINESS_TAB_DEFINITIONS = [
    ...
    TAB_DIVIDER,
    {
        "slug": "business-plan",
        "label": "Business Plan",
        "template": "business/tabs/consolidated_business_plan.html",
        "availability_fn": views._tab_available_business_plan_consolidated,
        "context_fn": views._tab_context_business_plan_consolidated,
        "sub_tabs": [
            {
                "slug": "business-plan",
                "label": "Business Plan",
    ...
    },
    {
        ...
        "template": "business/tabs/consolidated_implementation.html",
        "availability_fn": views._tab_available_implementation_consolidated,
        "context_fn": views._tab_context_implementation_consolidated,
        "sub_tabs": [
            {
                "slug": "architecture",
                "label": "Architecture",
            ...
            },
            {
                "slug": "credentials",
                "label": "Credentials",
                "template": "business/tabs/credentials.html",
                "context_fn": views._tab_context_credentials,
            },
            {
                "slug": "infrastructure-stacks",
                "label": "Infrastructure",
